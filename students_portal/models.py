...
class DiscussionTopic(models.Model):
    ...
    programme = models.ForeignKey(Programme, on_delete=models.CASCADE, related_name='topics')
    author = models.ForeignKey(User, on_delete=models.CASCADE)
    title = models.CharField(max_length=200)
    content = models.TextField()
    topic_type = models.CharField(max_length=20, choices=TYPE_CHOICES, default='discussion')
